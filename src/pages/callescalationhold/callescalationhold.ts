...
@IonicPage()
@Component({
  selector: 'page-callescalationhold',
  templateUrl: 'callescalationhold.html',
})

export class callEscalationHoldpage {
  ...
  CallEscalationOnHoldSearch:any;
  ...
  getregisterdata() {
    ...
    this.authService.postData(arr_data, 'Call_inspection/getCallEscalationHoldList').then((result) => {
      this.presentLoadingDefault(false);
      this.Callprocurementvalue = result;
      this.CallEscalationOnHoldSearch = result;
    }, (err) => {
      this.presentLoadingDefault(false);
  ...
  SearchcallManagement() {
    ...
    if (case_val != '') {
      let filterData = this.CallEscalationOnHoldSearch.filter(item => this.filter(item));
      this.Callprocurementvalue = filterData;
    } else {
      this.Callprocurementvalue = this.CallEscalationOnHoldSearch
    }
    console.log(this.Callprocurementvalue);
  }
